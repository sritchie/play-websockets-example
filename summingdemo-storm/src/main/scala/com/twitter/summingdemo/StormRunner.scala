...
object StormRunner {
  ...
  lazy val config = new ConfigurationBuilder()
    .setOAuthConsumerKey("bvYHX6kCJznOb7ndV9gvXQ")
    .setOAuthConsumerSecret("yHMORTnmweN4PoNXd4rbiKTEl5VeudjBgjVp3cj0l68")
    .setOAuthAccessToken("14074371-WnodC8Zzd9mf1tKoCPP63phfdCvvbZcuqekDDHhXV")
    .setOAuthAccessTokenSecret("P4HrwHYYddn7lJZBOEPceymZkShFwi1jqq1uCLrYCU")
    .build
